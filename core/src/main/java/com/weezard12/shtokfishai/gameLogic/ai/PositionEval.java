...
public class PositionEval {
    ...
    public String toString() {
        return String.format("material: %s, pieces activity: %s king moves: %s, pawn structure: %s, sum: %s",materialValue,piecesActivity,kingMoves,pawnStructure,getSumEval()/*position==null?"empty position": GameBoard.toStringBoardArray(position)*/);
    }
}
